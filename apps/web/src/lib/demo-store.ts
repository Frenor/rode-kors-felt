...
let patients: any[] = [
  ...
  },
  {
    ...
    positionText: 'Inngangsparti, vest tribune',
    lat: 59.9650,
    lon: 10.6690,
  ...
  },
  {
    ...
    positionText: 'Sektor B, rad 5 — ved drikkestasjonen',
    lat: 59.9628,
    lon: 10.6708,
    assignedClinician: 'Lege Andersen',
    vitalsHistory: [
  ...
  },
  {
    ...
    positionText: 'Start-/målområde, sør',
    lat: 59.9610,
    lon: 10.6718,
    assignedClinician: '',
    vitalsHistory: [],
  ...
  },
  {
    ...
    status: 'incoming',
    presentingComplaint: 'Bevisstløs, ukjent årsak',
    positionText: 'Km 12, løypebok ved grantre',
    lat: 59.9638,
    lon: 10.6645,
    assignedClinician: '',
    vitalsHistory: [],
